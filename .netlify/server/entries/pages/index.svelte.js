...
const css$f = {
  code: `.soft-mode #hero.svelte-1vpjnve.svelte-1vpjnve{background-image:none !important;background-color:#ffa666}#socials.svelte-1vpjnve.svelte-1vpjnve{position:absolute;top:90%;z-index:10;color:white;font-family:"Oswald";font-size:24px;left:42%}#social-links.svelte-1vpjnve.svelte-1vpjnve{list-style:none;margin:0;cursor:pointer}.tooltip.svelte-1vpjnve.svelte-1vpjnve{display:none;position:absolute;padding:10px;width:150px;right:0px;font-size:1.5rem;background-color:rgb(34,34,34);color:white;font-family:"Oswald";overflow:hidden}#socials.svelte-1vpjnve:active .tooltip.svelte-1vpjnve,.tooltip.svelte-1vpjnve.svelte-1vpjnve:active{display:block}#socials.svelte-1vpjnve:hover .tooltip.svelte-1vpjnve,.tooltip.svelte-1vpjnve.svelte-1vpjnve:hover{display:block}#hero-logo.svelte-1vpjnve.svelte-1vpjnve{position:absolute;left:50%;transform:translateX(-50%);height:50%;max-width:100%;mix-blend-mode:soft-light}.scrolling-content.svelte-1vpjnve.svelte-1vpjnve{margin-left:10px;font-size:64px;height:64px;text-align:left;line-height:1;text-overflow:ellipsis;width:200px;white-space:nowrap;color:white}#socials.svelte-1vpjnve a.svelte-1vpjnve{color:var(--highlight)}.content.svelte-1vpjnve.svelte-1vpjnve{text-align:right;font-size:64px;line-height:64px;text-align:right;color:#ecf0f1;padding:0;white-space:nowrap;position:relative;display:inline-block;min-height:0;font-weight:600;overflow:hidden}.scrolling-content-mask.svelte-1vpjnve.svelte-1vpjnve{height:64px;overflow:hidden;position:relative;display:inline-block}.left-content.svelte-1vpjnve.svelte-1vpjnve{font-weight:500;margin:0px;height:64px;z-index:1;display:grid;grid-template-columns:48% 52%}#hero.svelte-1vpjnve.svelte-1vpjnve{position:relative;width:100%;height:100vh;display:grid;background-position:center;background-size:100% 100%;grid-template-columns:55% 45%;justify-content:space-between;align-items:center}@media screen and (max-width: 820px){.soft-mode #hero::before{background-image:none !important;background-color:#ffa666 !important}#hero.svelte-1vpjnve.svelte-1vpjnve::before{background-image:url('../images/mobile_hero.png')}#hero-logo.svelte-1vpjnve.svelte-1vpjnve{height:auto !important}#socials.svelte-1vpjnve.svelte-1vpjnve{display:table;margin-left:auto;margin-right:auto;padding-bottom:20px;position:relative;left:0}#hero.svelte-1vpjnve.svelte-1vpjnve{display:flex;flex-direction:column;height:auto;align-items:center;justify-content:center;min-height:100vh}.description.svelte-1vpjnve.svelte-1vpjnve{display:table-cell;text-align:center;padding:20px}.left-content.svelte-1vpjnve.svelte-1vpjnve{padding-top:100px;width:100%;display:flex;flex-direction:column;height:auto}.scrolling-content.svelte-1vpjnve.svelte-1vpjnve{margin-top:20px\r
        }.content.svelte-1vpjnve.svelte-1vpjnve{text-align:center}.scroll-animation.svelte-1vpjnve.svelte-1vpjnve{text-align:center !important}}.description.svelte-1vpjnve.svelte-1vpjnve{position:relative;font-weight:400;width:90%;height:auto}.hero-split.svelte-1vpjnve.svelte-1vpjnve{color:white}p.svelte-1vpjnve.svelte-1vpjnve{font-size:1.6rem;line-height:2.25rem;display:inline;float:left;margin:0}.scroll-animation.svelte-1vpjnve.svelte-1vpjnve{min-height:150px;max-height:150px;margin:0px;padding:0px;background-size:contain;font-size:64px;margin-top:0;position:relative;text-align:left;list-style:none;animation:svelte-1vpjnve-change 3.5s cubic-bezier(0.5, 0.2, 0.5, 1.0) 0.5s 1 normal forwards;-webkit-animation:svelte-1vpjnve-change 3.5s cubic-bezier(0.8, 0.3, 0.3, 1.0) 0.5s 1 normal forwards}.scroll-animation.svelte-1vpjnve li.svelte-1vpjnve{margin:0}@-webkit-keyframes svelte-1vpjnve-opacity{0%,100%{opacity:0}50%{opacity:1}}@-webkit-keyframes svelte-1vpjnve-change{100%{margin-top:-2688px}}@keyframes svelte-1vpjnve-opacity{0%,100%{opacity:0}50%{opacity:1}}@keyframes svelte-1vpjnve-change{100%{margin-top:-2694px}}.soft-mode #hero::before{background-image:none !important;background-color:#ffa666}@media screen and (max-width: 820px){.soft-mode #hero::before{background-image:none !important;background-color:#ffa666 !important}#hero.svelte-1vpjnve.svelte-1vpjnve::before{background-image:url('images/mobile_hero.png')}#hero-logo.svelte-1vpjnve.svelte-1vpjnve{height:auto !important}#socials.svelte-1vpjnve.svelte-1vpjnve{display:table;margin-left:auto;margin-right:auto;padding-bottom:20px;position:relative;left:0}#hero.svelte-1vpjnve.svelte-1vpjnve{display:flex;flex-direction:column;height:auto;align-items:center;justify-content:center;min-height:100vh}.description.svelte-1vpjnve.svelte-1vpjnve{display:table-cell;text-align:center;padding:20px}.left-content.svelte-1vpjnve.svelte-1vpjnve{padding-top:100px;display:flex;flex-direction:column;height:auto}.scrolling-content.svelte-1vpjnve.svelte-1vpjnve{margin-top:20px;width:100%;display:flex;justify-content:center}.content.svelte-1vpjnve.svelte-1vpjnve{text-align:center}.scroll-animation.svelte-1vpjnve.svelte-1vpjnve{text-align:center !important}}`,
  map: null
};
const Hero = (0, import_index_4f192781.c)(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_t();
  return `<div style="${"background-image:url('images/tags_hero_bg.png')"}" id="${"hero"}" class="${"svelte-1vpjnve"}"><img loading="${"lazy"}" alt="${"AllSkills logo"}" id="${"hero-logo"}" src="${"images/logo-border-2.png"}" class="${"svelte-1vpjnve"}">
   <div class="${"left-content svelte-1vpjnve"}"><div class="${"content svelte-1vpjnve"}">${(0, import_index_4f192781.e)($t("en.home.hero.title"))}</div>
    ...
    return `<li class="${"svelte-1vpjnve"}">${(0, import_index_4f192781.e)(skill)}</li>`;
                    ...
                    <li style="${"color:var(--highlight); font-weight: 600 !important; font-family:'Bebas Neue'; margin-top:11px;"}" class="${"svelte-1vpjnve"}"><h1 style="${"margin:0; font-size:64px;"}">AllSkills</h1></li></ul></div></div></div>
    ...
    <div id="${"socials"}" class="${"svelte-1vpjnve"}"><div class="${"tooltip svelte-1vpjnve"}"><ul id="${"social-links"}" class="${"svelte-1vpjnve"}"><a href="${"https://twitter.com/@AllSkillsNFT"}" class="${"svelte-1vpjnve"}">Twitter</a>
                <a href="${"https://www.instagram.com/AllSkillsNFT/"}" class="${"svelte-1vpjnve"}">Instagram</a>
                <a href="${"https://www.tiktok.com/@allskillsnft"}" class="${"svelte-1vpjnve"}">TikTok</a>
                <a href="${"https://www.facebook.com/AllSkillsNFT"}" class="${"svelte-1vpjnve"}">Facebook</a></ul></div>
          <span>Check us out <a class="${"svelte-1vpjnve"}">@AllSkillsNFT</a></span></div>
...
const css$d = {
  code: `.soft-mode .first span.svelte-csxu8e.svelte-csxu8e{color:blueviolet !important}.soft-mode .first.svelte-csxu8e .title.svelte-csxu8e{background-image:linear-gradient(gold,gold) !important}.soft-mode .second.svelte-csxu8e .title.svelte-csxu8e{background-image:linear-gradient(blueviolet, blueviolet) !important}.soft-mode .second span.svelte-csxu8e.svelte-csxu8e{color:blueviolet !important}.soft-mode .info-card{border-radius:20px;padding:20px;box-shadow:0px 2px 10px rgba(0,0,0,0.1);display:block !important}.soft-mode h3.svelte-csxu8e.svelte-csxu8e,.info-card.svelte-csxu8e p.svelte-csxu8e{color:white}.info-card.svelte-csxu8e.svelte-csxu8e{background-size:0 !important;display:contents}#resButton.svelte-csxu8e.svelte-csxu8e{position:absolute;background-color:blueviolet;border-radius:20px;color:white;border:none;font-family:'Bebas Neue';padding:10px;top:330px;left:80px;z-index:11;box-shadow:0px 0px 15px 5px #0ff}.shake.svelte-csxu8e.svelte-csxu8e{animation:svelte-csxu8e-shake 1.8s cubic-bezier(.36,.07,.19,.97) infinite;transform:translate3d(0, 0, 0)}.open{animation:svelte-csxu8e-shakefast 0.5s linear;animation-iteration-count:4}@keyframes svelte-csxu8e-shake{0%,70%{transform:translate3d(-1px, 0, 0)}5%,60%{transform:translate3d(2px, 0, 0)}10%,30%,50%{transform:translate3d(-4px, 0, 0)}15%,40%{transform:translate3d(4px, 0, 0)}70%,100%{transform:translate3d(0, 0, 0)}}@keyframes svelte-csxu8e-shakefast{0%{transform:translate(1px, 1px) rotate(0deg)}10%{transform:translate(-1px, -2px) rotate(-1deg)}20%{transform:translate(-3px, 0px) rotate(1deg)}30%{transform:translate(3px, 2px) rotate(0deg)}40%{transform:translate(1px, -1px) rotate(1deg)}50%{transform:translate(-1px, 2px) rotate(-1deg)}60%{transform:translate(-3px, 1px) rotate(0deg)}70%{transform:translate(3px, 1px) rotate(-1deg)}80%{transform:translate(-1px, -1px) rotate(1deg)}90%{transform:translate(1px, 2px) rotate(0deg)}100%{transform:translate(1px, -2px) rotate(-1deg)}}#doneModal.svelte-csxu8e.svelte-csxu8e{position:absolute;background-color:rgba(0,0,0,0.5) !important;width:250px;top:-58px;left:125px;z-index:10;height:390px}#winModal.svelte-csxu8e.svelte-csxu8e{position:absolute;background-color:rgba(0,0,0,0.5) !important;background-position-y:center !important;background-size:contain !important;background:url('../images/win_screen.png');background-repeat:no-repeat;border-radius:20px;width:250px;top:-110px;left:125px;z-index:11;height:490px}.title.svelte-csxu8e.svelte-csxu8e{background-size:0% 5px}.tooltips.svelte-csxu8e.svelte-csxu8e{position:absolute;width:100%;height:100%;top:0}.extra-info.svelte-csxu8e.svelte-csxu8e{position:absolute;display:inline-block;width:100px;font-size:13px;font-weight:300;text-align:right}.info-left.svelte-csxu8e.svelte-csxu8e{text-align:left;width:100px;left:400px}#music.svelte-csxu8e.svelte-csxu8e{top:-20%}#effects.svelte-csxu8e.svelte-csxu8e{top:23%}#gifs.svelte-csxu8e.svelte-csxu8e{top:-20%}#crop.svelte-csxu8e.svelte-csxu8e{margin-top:30px}#name.svelte-csxu8e.svelte-csxu8e{top:12%}#tags.svelte-csxu8e.svelte-csxu8e{top:28%;width:25%}#tags.svelte-csxu8e p.svelte-csxu8e{margin-block-end:0.4rem;margin-block-start:0.4rem}h3.svelte-csxu8e.svelte-csxu8e{font-size:2rem;padding-bottom:10px;font-family:"Oswald";text-decoration:none;background-position:0% 100%;background-size:0% 2px;background-repeat:no-repeat}.first.svelte-csxu8e.svelte-csxu8e{order:1;margin-left:-25px}.second.svelte-csxu8e.svelte-csxu8e{order:2}.content.svelte-csxu8e p.svelte-csxu8e{font-size:1.2rem;line-height:1.8rem;font-weight:400}.content.svelte-csxu8e.svelte-csxu8e{flex:0 0 50%}.image.svelte-csxu8e.svelte-csxu8e{flex:0 0 50%;width:50%;position:relative}.phone.svelte-csxu8e.svelte-csxu8e{position:relative;top:-125px;left:100px;width:300px}.challenge-container.svelte-csxu8e.svelte-csxu8e{max-width:1220px;margin-left:auto;margin-right:auto;display:flex;width:85%;margin-bottom:80px;flex-direction:column}.info-section.svelte-csxu8e.svelte-csxu8e{display:flex;gap:50px;margin-top:250px;height:500px}@media screen and (max-width: 820px){.info-section.svelte-csxu8e.svelte-csxu8e{width:100%;flex-direction:column;margin:0;gap:0;height:auto}.image.svelte-csxu8e.svelte-csxu8e{order:2 !important;width:auto;margin-top:30px;margin-right:auto;margin-left:auto}.phone.svelte-csxu8e.svelte-csxu8e{top:0;left:0}#doneModal.svelte-csxu8e.svelte-csxu8e{top:68px;left:25px}#winModal.svelte-csxu8e.svelte-csxu8e{top:15px;left:25px}.second.svelte-csxu8e.svelte-csxu8e{order:1}.first.svelte-csxu8e.svelte-csxu8e{order:1;margin-left:auto}.tooltips.svelte-csxu8e.svelte-csxu8e{display:none}}`,
  map: null
};
const Challenge = (0, import_index_4f192781.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `<section id="${"Challenge"}"><h2 class="${"section-title"}" style="${"text-decoration-color: var(--firstColor); -webkit-text-decoration-color: var(--firstColor)"}">Challenge System</h2>
    <div class="${"challenge-container svelte-csxu8e"}"><div class="${"info-section svelte-csxu8e"}"><div class="${"image first svelte-csxu8e"}"><img alt="${"Edit videos"}" class="${"phone svelte-csxu8e"}" src="${"images/challenge_edit.png"}">
                <div class="${"tooltips svelte-csxu8e"}" style="${"color:var(--firstColor); "}"><p id="${"music"}" class="${"extra-info svelte-csxu8e"}"><span style="${"text-decoration:underline; color:white;"}" class="${"svelte-csxu8e"}">Music</span><br>Users will get to chose from a variety of song clips to add to their videos</p>
                    <p id="${"filters"}" class="${"extra-info svelte-csxu8e"}"><span style="${"text-decoration:underline;color:white;"}" class="${"svelte-csxu8e"}">Filters</span><br>Users will have access to a number of filters to put over their videos</p>
                    <p id="${"effects"}" class="${"extra-info svelte-csxu8e"}"><span style="${"text-decoration:underline;color:white;"}" class="${"svelte-csxu8e"}">Effects</span><br>A number of video effects will be available to enhance the quality of the users videos.</p>
                    <p id="${"gifs"}" class="${"extra-info info-left svelte-csxu8e"}"><span style="${"text-decoration:underline;color:white;"}" class="${"svelte-csxu8e"}">GIFs</span><br>To add a unique touch to your trickshots, add a GIF for a built-in reaction to the users skills.</p>
                    <p id="${"crop"}" class="${"extra-info info-left svelte-csxu8e"}"><span style="${"text-decoration:underline;color:white;"}" class="${"svelte-csxu8e"}">Crop</span><br>To cut and crop their videos, users are invited to use the trimming feature.</p></div></div>
            <div class="${"content second svelte-csxu8e"}"><div style="${"background-color: var(--firstColor);"}" class="${"info-card svelte-csxu8e"}"><h3 class="${"title svelte-csxu8e"}" style="${"background-image: linear-gradient(var(--firstColor), var(--firstColor));"}">${(0, import_index_4f192781.e)($t("en.home.challenges.videos.title"))}</h3>
                <p class="${"svelte-csxu8e"}">${(0, import_index_4f192781.e)($t("en.home.challenges.videos.pStart"))} <span style="${"color:var(--firstColor);"}" class="${"svelte-csxu8e"}">${(0, import_index_4f192781.e)($t("en.home.challenges.videos.highlighted"))}</span>${(0, import_index_4f192781.e)($t("en.home.challenges.videos.pEnd"))}</p></div></div></div>
        <div class="${"info-section svelte-csxu8e"}"><div class="${"image second svelte-csxu8e"}"><img alt="${"Upload videos"}" class="${"phone svelte-csxu8e"}" src="${"images/challenge_upload.png"}">
                <div class="${"tooltips svelte-csxu8e"}" style="${"color:var(--secondColor)"}"><p id="${"music"}" class="${"extra-info info-left svelte-csxu8e"}">Users will have the option to save their video to their camera roll.</p>
                    <p id="${"name"}" class="${"extra-info info-left svelte-csxu8e"}">Choose a unique name for your trickshot.</p>
                    <div id="${"tags"}" class="${"extra-info info-left svelte-csxu8e"}"><p class="${"svelte-csxu8e"}">By adding SkillsTags to each video, users will be able to increase their reach and voting results.</p>
                        <p class="${"svelte-csxu8e"}">Users will be able to use this area to search for or create their own SkillsTags for their video.</p>
                        <p class="${"svelte-csxu8e"}">A total of 6 SkillsTags will be listed and added to each video.</p></div></div></div>
            <div class="${"content first svelte-csxu8e"}"><div class="${"info-card svelte-csxu8e"}" style="${"background-color: var(--secondColor);"}"><h3 class="${"title svelte-csxu8e"}" style="${"background-image: linear-gradient(var(--secondColor),var(--secondColor));"}">${(0, import_index_4f192781.e)($t("en.home.challenges.challenges.title"))}</h3>
                <p class="${"svelte-csxu8e"}">${(0, import_index_4f192781.e)($t("en.home.challenges.challenges.pStart"))}  <span style="${"color:var(--secondColor);"}" class="${"svelte-csxu8e"}">${(0, import_index_4f192781.e)($t("en.home.challenges.challenges.highlighted"))}</span> ${(0, import_index_4f192781.e)($t("en.home.challenges.challenges.pEnd"))}</p></div></div></div>
        <div class="${"info-section svelte-csxu8e"}"><div class="${"image first svelte-csxu8e"}"><img alt="${"Users vote for winner"}" class="${"phone svelte-csxu8e"}" src="${"images/challenge_current.png"}">
                <div class="${"tooltips svelte-csxu8e"}" style="${"color:var(--thirdColor)"}"><p id="${"music"}" class="${"extra-info svelte-csxu8e"}">Users will see freezeframe of the 2 videos and they can tap on the Play button to watch each video.</p></div></div>
            <div class="${"content second svelte-csxu8e"}"><div class="${"info-card svelte-csxu8e"}" style="${"background-color: var(--thirdColor);"}"><h3 class="${"title svelte-csxu8e"}" style="${"background-image: linear-gradient(blueviolet,blueviolet);"}">${(0, import_index_4f192781.e)($t("en.home.challenges.votes.title"))}</h3>
                <p class="${"svelte-csxu8e"}">${(0, import_index_4f192781.e)($t("en.home.challenges.votes.pStart"))} <span style="${"color:blueviolet;"}" class="${"svelte-csxu8e"}">${(0, import_index_4f192781.e)($t("en.home.challenges.votes.highlighted"))}</span> ${(0, import_index_4f192781.e)($t("en.home.challenges.votes.pEnd"))}</p></div></div></div>
        <div class="${"info-section svelte-csxu8e"}"><div class="${"image second svelte-csxu8e"}"><div id="${"winModal"}" style="${"display:none;"}" class="${"svelte-csxu8e"}"></div>
                <div id="${"doneModal"}" class="${"svelte-csxu8e"}"><button class="${"shake svelte-csxu8e"}" id="${"resButton"}">View Results</button></div>
                <img alt="${"Rewards"}" class="${"phone svelte-csxu8e"}" src="${"images/challenge_win.png"}"></div>
            <div class="${"content first svelte-csxu8e"}"><div class="${"info-card svelte-csxu8e"}" style="${"background-color: var(--fourthColor);"}"><h3 class="${"title svelte-csxu8e"}" style="${"background-image: linear-gradient(gold,gold);"}">${(0, import_index_4f192781.e)($t("en.home.challenges.earn.title"))}</h3>
                <p class="${"svelte-csxu8e"}">${(0, import_index_4f192781.e)($t("en.home.challenges.earn.pStart"))}<span style="${"color: gold;"}" class="${"svelte-csxu8e"}">${(0, import_index_4f192781.e)($t("en.home.challenges.earn.highlighted"))}</span></p></div></div></div></div>
</section>`;
});
var Tokens_svelte_svelte_type_style_lang = "";
const css$c = {
  code: `.soft-mode #Tokens.svelte-19xzsnk.svelte-19xzsnk{padding-top:400px;color:var(--fourthColor);background-size:cover;background-repeat:no-repeat}#Tokens.svelte-19xzsnk.svelte-19xzsnk{background-size:0}.column-header.svelte-19xzsnk.svelte-19xzsnk{background:white;color:rgb(30,30,30);border-radius:40px;width:90%;text-align:center;margin-bottom:30px;margin-left:auto;margin-right:auto}.soft.svelte-19xzsnk.svelte-19xzsnk{display:none}.soft-mode .soft.svelte-19xzsnk.svelte-19xzsnk{display:block !important}.soft-mode .hard.svelte-19xzsnk.svelte-19xzsnk{display:none}.section.svelte-19xzsnk:hover h3.svelte-19xzsnk{text-decoration-line:underline;text-decoration-color:gold;-webkit-text-decoration-line:underline;-webkit-text-decoration-color:gold}#value.svelte-19xzsnk.svelte-19xzsnk{font-family:'Oswald';grid-area:value;color:var(--highlight)}.highlight.svelte-19xzsnk.svelte-19xzsnk{color:var(--highlight)}.middle.svelte-19xzsnk.svelte-19xzsnk{display:flex;flex-direction:column;align-items:center;justify-content:center;grid-area:middle;margin-left:auto;margin-right:auto}h3.svelte-19xzsnk.svelte-19xzsnk{margin:0;font-size:1.75vw;font-weight:400;font-family:"Oswald";color:var(--baseText)}.section.svelte-19xzsnk p.svelte-19xzsnk{margin-left:42px;font-family:"Lato";font-size:1.25vw;line-height:1.5vw;font-weight:400}.soft-mode .section p.svelte-19xzsnk.svelte-19xzsnk{background-color:white;border-radius:15px;font-size:1.2rem !important;padding:15px}.section.svelte-19xzsnk img.svelte-19xzsnk{float:left;margin-right:10px;width:32px;height:32px}.section.svelte-19xzsnk .title.svelte-19xzsnk{margin-right:-7%;display:inline-flex;align-items:center}.column.svelte-19xzsnk.svelte-19xzsnk{width:80%}.vote-container.svelte-19xzsnk.svelte-19xzsnk{max-width:1220px;margin-top:100px;padding-bottom:100px;margin-left:auto;margin-right:auto;display:grid;min-height:525px;margin-bottom:200px;margin-left:auto;margin-right:auto;grid-template-columns:1fr 1.25fr 1fr !important;justify-content:space-evenly;grid-template:"left middle right"
            "left middle right"
            "left middle right"
            "left middle right";grid-auto-flow:column}@media screen and (min-width: 1920px){p.svelte-19xzsnk.svelte-19xzsnk{font-size:1.1rem !important}}@media screen and (max-width: 820px){.vote-container.svelte-19xzsnk.svelte-19xzsnk{display:flex;flex-direction:column;height:auto;width:90%;max-height:100%}.column.svelte-19xzsnk.svelte-19xzsnk{width:100%}p.svelte-19xzsnk.svelte-19xzsnk{font-size:1rem !important;line-height:1.5rem !important}h3.svelte-19xzsnk.svelte-19xzsnk{font-size:1.75rem !important}}span.svelte-19xzsnk.svelte-19xzsnk{font-family:"Montserrat", sans-serif}.jump.svelte-19xzsnk.svelte-19xzsnk{animation:svelte-19xzsnk-jump 1.5s infinite ease}@keyframes svelte-19xzsnk-jump{0%{top:0}50%{top:-15px}100%{top:0}}.coin.svelte-19xzsnk.svelte-19xzsnk{margin:auto;position:relative;bottom:0;left:0;right:0;top:50px;height:300px;width:150px}.coin.svelte-19xzsnk .front.svelte-19xzsnk{position:absolute;height:150px;width:150px;background:#ffbd0b;border-radius:50%;border-top:7px solid #ffd84c;border-left:7px solid #ffd84c;border-right:7px solid #d57e08;border-bottom:7px solid #d57e08;transform:rotate(44deg)}.coin.svelte-19xzsnk .front.svelte-19xzsnk:before{content:"";margin:35.5px 35.5px;position:absolute;width:70px;height:70px;background:#f0a608;border-radius:50%;border-bottom:5px solid #ffd84c;border-right:5px solid #ffd84c;border-left:5px solid #d57e08;border-top:5px solid #d57e08;z-index:2}.coin.svelte-19xzsnk .front .currency.svelte-19xzsnk,.coin.svelte-19xzsnk .back .currency.svelte-19xzsnk{overflow:hidden;position:absolute;color:#ffbd0b;font-size:32px;transform:rotate(-44deg);line-height:4.5;width:97%;height:99%;text-align:center;text-shadow:0 3px 0 #cb7407;z-index:3;border-radius:50%}.currency.svelte-19xzsnk.svelte-19xzsnk{background-repeat:no-repeat;background-size:30%;background-position:center}.coin.svelte-19xzsnk .front .currency.svelte-19xzsnk:after,.coin.svelte-19xzsnk .back .currency.svelte-19xzsnk:after{content:"";position:absolute;height:210px;width:40px;margin:20px -65px;box-shadow:50px -23px 0 -10px rgba(255, 255, 255, 0.22), 85px -10px 0 -16px rgba(255, 255, 255, 0.19);transform:rotate(-50deg);animation:svelte-19xzsnk-shine 1.5s infinite ease}@keyframes svelte-19xzsnk-shine{0%{margin:20px -65px}50%{margin:45px -75px}100%{margin:20px -65px}}.coin.svelte-19xzsnk .front .shapes.svelte-19xzsnk,.coin.svelte-19xzsnk .back .shapes.svelte-19xzsnk{transform:rotate(-44deg);position:absolute;top:0;left:0;width:100%;height:100%}.coin.svelte-19xzsnk .front .shapes div.svelte-19xzsnk,.coin.svelte-19xzsnk .back .shapes div.svelte-19xzsnk{margin:63px 0px;font-size:20px;color:#cb7407}.coin.svelte-19xzsnk .front .shape_l.svelte-19xzsnk,.coin.svelte-19xzsnk .back .shape_l.svelte-19xzsnk{float:left}.coin.svelte-19xzsnk .front .shape_r.svelte-19xzsnk,.coin.svelte-19xzsnk .back .shape_r.svelte-19xzsnk{float:right}.coin.svelte-19xzsnk .front .top.svelte-19xzsnk,.coin.svelte-19xzsnk .back .top.svelte-19xzsnk{font-size:24px;color:#d67f08;text-align:center;width:100%;position:absolute;top:0;font-family:"Oswald";left:0}.coin.svelte-19xzsnk .front .bottom.svelte-19xzsnk,.coin.svelte-19xzsnk .back .bottom.svelte-19xzsnk{font-size:24px;color:#d67f08;text-align:center;width:100%;position:absolute;font-family:"Oswald";left:0;bottom:5px}.coin.svelte-19xzsnk .shadow.svelte-19xzsnk{width:100%;height:20px;background:rgba(0, 0, 0, 0.4);left:0;bottom:-50px;border-radius:50%;z-index:-1;margin:185px 7px 0 7px;animation:svelte-19xzsnk-swift 1.5s infinite ease}@keyframes svelte-19xzsnk-swift{0%{opacity:0.8}50%{opacity:0.4;transform:scale(0.8)}100%{opacity:0.8}}`,
  map: null
};
const Tokens = (0, import_index_4f192781.c)(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_t();
  return `<section id="${"Tokens"}" style="${"background-image: url('images/bluewaves.svg')"}" class="${"svelte-19xzsnk"}"><h2 class="${"section-title center"}" style="${"text-decoration-color: var(--fourthColor); -webkit-text-decoration-color: var(--fourthColor)"}">ALLSKILLS Token System</h2>
  <div class="${"vote-container svelte-19xzsnk"}"><div class="${"column-header svelte-19xzsnk"}"><h2 style="${"color:blueviolet"}">$VOTE Token</h2></div>
        <div class="${"section left svelte-19xzsnk"}"><span class="${"title svelte-19xzsnk"}"><img alt="${"Stable value"}" src="${"images/stable.png"}" class="${"svelte-19xzsnk"}">
              <h3 class="${"svelte-19xzsnk"}">${(0, import_index_4f192781.e)($t("en.home.vote.stable.title"))}</h3></span>
          <p class="${"svelte-19xzsnk"}">${(0, import_index_4f192781.e)($t("en.home.vote.stable.pStart"))} <span class="${"highlight svelte-19xzsnk"}">${(0, import_index_4f192781.e)($t("en.home.vote.stable.highlighted"))}</span> ${(0, import_index_4f192781.e)($t("en.home.vote.stable.pEnd"))}</p></div>
      <div class="${"section left svelte-19xzsnk"}"><span class="${"title svelte-19xzsnk"}"><img class="${"soft svelte-19xzsnk"}" alt="${"Vote"}" src="${"images/vote_soft.png"}">
            <img class="${"hard svelte-19xzsnk"}" alt="${"Vote"}" src="${"images/vote.png"}">
            <h3 class="${"svelte-19xzsnk"}">${(0, import_index_4f192781.e)($t("en.home.vote.cast.title"))}</h3></span>
        <p class="${"svelte-19xzsnk"}">${(0, import_index_4f192781.e)($t("en.home.vote.cast.pStart"))} <span class="${"highlight svelte-19xzsnk"}">${(0, import_index_4f192781.e)($t("en.home.vote.cast.highlighted"))}</span> ${(0, import_index_4f192781.e)($t("en.home.vote.cast.pEnd"))}</p></div>
        <div class="${"section left svelte-19xzsnk"}"><span class="${"title svelte-19xzsnk"}"><img class="${"soft svelte-19xzsnk"}" alt="${"Earnings"}" src="${"images/earnings_soft.png"}">
              <img class="${"hard svelte-19xzsnk"}" alt="${"Earnings"}" src="${"images/earnings.png"}">
              <h3 class="${"svelte-19xzsnk"}">${(0, import_index_4f192781.e)($t("en.home.vote.win.title"))}</h3></span>
            <p class="${"svelte-19xzsnk"}">${(0, import_index_4f192781.e)($t("en.home.vote.win.pStart"))} <span class="${"highlight svelte-19xzsnk"}">${(0, import_index_4f192781.e)($t("en.home.vote.win.highlighted"))}</span> ${(0, import_index_4f192781.e)($t("en.home.vote.win.pEnd"))}</p></div>
      <div class="${"column middle svelte-19xzsnk"}"><h4 id="${"value"}" class="${"svelte-19xzsnk"}">1 $Vote \u2248 $0.10</h4>
          <div class="${"coin svelte-19xzsnk"}"><div class="${"front jump svelte-19xzsnk"}"><div class="${"star svelte-19xzsnk"}"></div>
                <span class="${"currency svelte-19xzsnk"}" style="${"background-image:url('../images/logo-yellow-s.png')"}"></span>
                <div class="${"shapes svelte-19xzsnk"}"><div class="${"shape_l svelte-19xzsnk"}">10\xA2</div>
                  <div class="${"shape_r svelte-19xzsnk"}">10\xA2</div>
                  <span class="${"top svelte-19xzsnk"}">Vote</span>
                  <span class="${"bottom svelte-19xzsnk"}">Token</span></div></div>
              <div class="${"shadow svelte-19xzsnk"}"></div></div>
            
          </div>
      <div class="${"column-header svelte-19xzsnk"}"><h2 style="${"color:blueviolet"}">$SKILL Token</h2></div>
      <div class="${"section right svelte-19xzsnk"}"><span class="${"title svelte-19xzsnk"}"><img class="${"soft svelte-19xzsnk"}" alt="${"Stake"}" src="${"images/stake_soft.png"}">
            <img class="${"hard svelte-19xzsnk"}" alt="${"Stake"}" src="${"images/stake.png"}">
            <h3 class="${"svelte-19xzsnk"}">${(0, import_index_4f192781.e)($t("en.home.vote.earn.title"))}</h3></span>
        <p class="${"svelte-19xzsnk"}">${(0, import_index_4f192781.e)($t("en.home.vote.earn.pStart"))} <span class="${"highlight svelte-19xzsnk"}">${(0, import_index_4f192781.e)($t("en.home.vote.earn.highlighted"))}</span> ${(0, import_index_4f192781.e)($t("en.home.vote.earn.pEnd"))}</p></div>
          <div class="${"section right svelte-19xzsnk"}"><span class="${"title svelte-19xzsnk"}"><img class="${"soft svelte-19xzsnk"}" alt="${"Royalties"}" src="${"images/revenue_soft.png"}">
                <img class="${"hard svelte-19xzsnk"}" alt="${"Royalties"}" src="${"images/revenue.png"}">
                  <h3 class="${"svelte-19xzsnk"}">${(0, import_index_4f192781.e)($t("en.home.vote.marketplace.title"))}</h3></span>
              <p class="${"svelte-19xzsnk"}">${(0, import_index_4f192781.e)($t("en.home.vote.marketplace.pStart"))} <span class="${"highlight svelte-19xzsnk"}">${(0, import_index_4f192781.e)($t("en.home.vote.marketplace.highlighted"))}</span> ${(0, import_index_4f192781.e)($t("en.home.vote.marketplace.pEnd"))}</p></div>
          <div class="${"section right svelte-19xzsnk"}"><span class="${"title svelte-19xzsnk"}"><img class="${"soft svelte-19xzsnk"}" alt="${"Replenish"}" src="${"images/replenish_soft.png"}">
                  <img class="${"hard svelte-19xzsnk"}" alt="${"Replenish"}" src="${"images/replenish.png"}">
                  <h3 class="${"svelte-19xzsnk"}">${(0, import_index_4f192781.e)($t("en.home.vote.utility.title"))}</h3></span>
              <p class="${"svelte-19xzsnk"}">${(0, import_index_4f192781.e)($t("en.home.vote.utility.pStart"))} <span class="${"highlight svelte-19xzsnk"}">${(0, import_index_4f192781.e)($t("en.home.vote.utility.highlighted"))}</span></p></div></div>
</section>`;
});
var NFT_svelte_svelte_type_style_lang = "";
const css$b = {
  code: `.soft-mode .info.svelte-71xfnq.svelte-71xfnq{border:none;overflow:hidden;border-radius:20px;color:white;box-shadow:2px 2px 10px rgba(0,0,0,0.3)}.soft-mode .right.svelte-71xfnq.svelte-71xfnq{background-color:#5497f0}.soft-mode #nft-info.svelte-71xfnq.svelte-71xfnq{margin-top:75px}.soft-mode .right.svelte-71xfnq a.svelte-71xfnq{color:gold}.soft-mode .right.svelte-71xfnq h4.svelte-71xfnq{font-family:'Varela'}.marker-highlight.svelte-71xfnq.svelte-71xfnq{background-position:center;background-repeat:no-repeat;background-size:80% 80%}.soft-mode div.right.svelte-71xfnq>.waves.svelte-71xfnq{display:block !important;position:absolute !important;top:-50px;left:-250px;width:100%;transform:rotate(345deg)}.soft-mode .marker-highlight.svelte-71xfnq.svelte-71xfnq{background-position:center !important;background-repeat:no-repeat !important;background-size:70% 70% !important;background:url("../images/paint_splatter_notes.png")}.soft-mode .lines.svelte-71xfnq.svelte-71xfnq{display:none}#overlay.svelte-71xfnq.svelte-71xfnq{position:fixed;z-index:9;top:0;left:0;height:100vh;width:100%;opacity:0.6;background-color:#000;visibility:visible}.modal.svelte-71xfnq.svelte-71xfnq{padding:20px;z-index:10;max-width:300px;max-height:500px;top:50%;left:50%;transform:translate(-50%, -50%);border-radius:20px;position:fixed;background-color:rgb(34,34,34);display:block}h4.svelte-71xfnq.svelte-71xfnq{padding-left:20px;padding-right:20px;line-height:30px}.right.svelte-71xfnq h4.svelte-71xfnq{margin-top:0;margin-bottom:20px}.info.svelte-71xfnq.svelte-71xfnq{background-color:rgb(14,14,14);position:relative;margin-bottom:20px;text-align:center;box-shadow:0px 10px 5px 3px rgb(0,0,0,0.5)}.right.svelte-71xfnq.svelte-71xfnq{border:3px solid rgba(0,255,255,0.5);transform:translateX(290px)}ul.svelte-71xfnq.svelte-71xfnq{font-size:1.3rem;list-style:none;text-align:left;padding-inline-start:0}.image.svelte-71xfnq.svelte-71xfnq{flex:0 0 50%;width:50%;display:flex;justify-content:center;position:relative}.image.svelte-71xfnq img.svelte-71xfnq{position:relative;align-self:center;width:300px;box-shadow:0px 5px 10px rgba(0,0,0,0.5)}.blurred.svelte-71xfnq.svelte-71xfnq{filter:blur(20px)}.NFT-container.svelte-71xfnq.svelte-71xfnq{display:flex;max-width:1220px;margin-right:auto;margin-left:auto;width:100%;flex-direction:column}.nft-section.svelte-71xfnq.svelte-71xfnq{display:flex;gap:50px;margin-top:80px}.first.svelte-71xfnq.svelte-71xfnq{order:1;margin-left:-25px}.second.svelte-71xfnq.svelte-71xfnq{order:2}.content.svelte-71xfnq.svelte-71xfnq{flex:0 0 50%;overflow:hidden}a.svelte-71xfnq.svelte-71xfnq{color:blueviolet;text-decoration:underline;cursor:pointer}@media screen and (max-width: 820px){.soft-mode div.right.svelte-71xfnq>svg.svelte-71xfnq{left:-15% !important}.NFT-container.svelte-71xfnq.svelte-71xfnq{width:90%}.nft-section.svelte-71xfnq.svelte-71xfnq{width:100%;flex-direction:column;gap:0;height:auto}.modal.svelte-71xfnq.svelte-71xfnq{width:100% !important}.soft-mode .marker-highlight.svelte-71xfnq.svelte-71xfnq{padding-top:30px;padding-bottom:30px;background-size:100% 100% !important}.marker-highlight.svelte-71xfnq.svelte-71xfnq{background-size:100% 100% !important}.image.svelte-71xfnq.svelte-71xfnq{order:1 !important;width:auto;margin-top:30px;margin-bottom:30px;margin-right:auto;margin-left:auto}.image.svelte-71xfnq img.svelte-71xfnq{top:0;left:0;width:75%}.second.svelte-71xfnq.svelte-71xfnq{order:1}.first.svelte-71xfnq.svelte-71xfnq{order:1;margin-left:auto}}`,
  map: null
};
...
const GM = (0, import_index_4f192781.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `<section id="${"GM"}"><h2 class="${"section-title"}" style="${"text-decoration-color: var(--firstColor); -webkit-text-decoration-color: var(--firstColor)"}">GM Mode</h2>
    <div class="${"GM-container svelte-rnrs8k"}"><div class="${"GM-section svelte-rnrs8k"}"><div class="${"image second svelte-rnrs8k"}"><img alt="${"GM Mode"}" src="${"images/gm_mode.png"}" class="${"svelte-rnrs8k"}"></div>
...
const Carousel = (0, import_index_4f192781.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"carousel-container svelte-1ki2tws"}"><div class="${"container svelte-1ki2tws"}"><input type="${"radio"}" name="${"slider"}" id="${"item-1"}" checked class="${"svelte-1ki2tws"}">
    ...
    <div class="${"cards svelte-1ki2tws"}"><label class="${"card svelte-1ki2tws"}" for="${"item-1"}" id="${"card-1"}"><img src="${"images/Chris_Boucher.jpeg"}" alt="${"NFT Trading Card"}" class="${"svelte-1ki2tws"}"></label>
        <label class="${"card svelte-1ki2tws"}" for="${"item-2"}" id="${"card-2"}"><div class="${"text-holder svelte-1ki2tws"}"><h3 class="${"overlay-text svelte-1ki2tws"}">Coming soon</h3></div>
          <img class="${"blurred svelte-1ki2tws"}" src="${"images/Dunk.webp"}" alt="${"NFT Trading Card"}"></label>
        <label class="${"card svelte-1ki2tws"}" for="${"item-3"}" id="${"card-3"}"><div class="${"text-holder svelte-1ki2tws"}"><h3 class="${"overlay-text svelte-1ki2tws"}">Coming soon</h3></div>
...
const css$6 = {
  code: ".card.svelte-1j40jyu h2.svelte-1j40jyu{color:white}a.svelte-1j40jyu.svelte-1j40jyu{cursor:pointer}.hidden.svelte-1j40jyu.svelte-1j40jyu{max-height:0px !important;overflow:hidden !important}.selected.svelte-1j40jyu.svelte-1j40jyu{left:25% !important}.card.svelte-1j40jyu .bgselected.svelte-1j40jyu::before{transition:border-width 0.25s linear !important;border-width:55px 0px 0px 5000px !important}.socials.svelte-1j40jyu.svelte-1j40jyu{display:flex;max-width:45%;justify-content:space-around}.socials-item.svelte-1j40jyu.svelte-1j40jyu{padding-left:2px;padding-right:2px;max-width:30%;align-self:center}.socials.svelte-1j40jyu img.svelte-1j40jyu{display:block}.card.svelte-1j40jyu.svelte-1j40jyu{font-family:'Roboto', Arial, sans-serif;align-items:flex-start;overflow:hidden;margin:0 auto 20px auto;min-width:230px;max-width:280px;line-height:1.2em;border-radius:15px;background-color:#141414;transition:all 0.3s ease;box-shadow:0px 0px 7px 1px rgba(0,0,0,0.3)}.card.svelte-1j40jyu.svelte-1j40jyu:hover{box-shadow:0px 0px 15px 0px rgba(0, 238, 255, 0.2)}.card.svelte-1j40jyu .svelte-1j40jyu{-webkit-box-sizing:border-box;box-sizing:border-box;-webkit-transition:all 0.25s ease;transition:all 0.25s ease}.card.svelte-1j40jyu img.svelte-1j40jyu{max-width:100%;vertical-align:top;opacity:0.85}.card.svelte-1j40jyu figcaption.svelte-1j40jyu{padding:25px;padding-bottom:0px;position:relative;transition:all 0.25s ease !important}.card.svelte-1j40jyu .slanted-bg.svelte-1j40jyu:before{position:absolute;content:'';bottom:100%;left:0;width:0;height:0;border-style:solid;border-width:55px 0 0 400px;border-color:transparent transparent transparent #141414;transition:border-width 0.25s ease !important}a.svelte-1j40jyu.svelte-1j40jyu:hover{opacity:1}.card.svelte-1j40jyu .profile.svelte-1j40jyu{border-radius:50%;position:absolute;bottom:100%;z-index:1;left:25px;max-width:150px;opacity:1;box-shadow:0 0 15px rgba(0, 0, 0, 0.3)}.card.svelte-1j40jyu h2.svelte-1j40jyu{margin:0 0 15px;font-size:1.4em;font-weight:400}.card.svelte-1j40jyu h2 span.svelte-1j40jyu{display:block;font-size:0.6em;color:aqua}.card.svelte-1j40jyu p.svelte-1j40jyu{margin:0 0 10px;font-size:0.9em;letter-spacing:1px;max-height:25em;overflow:auto;transition:max-height 0.25s, overflow 0.25s 0.25s !important;scrollbar-width:none;-ms-overflow-style:none}.card.svelte-1j40jyu.svelte-1j40jyu::-webkit-scrollbar{display:none}.cards-container.svelte-1j40jyu.svelte-1j40jyu{display:flex;margin-bottom:100px;max-width:1220px;margin-left:auto;margin-right:auto;width:90%;flex-wrap:wrap;align-items:flex-start;justify-content:space-between;margin-top:100px}.more-info.svelte-1j40jyu.svelte-1j40jyu{padding:10px;background-color:transparent;border:2px solid;color:#ffffff;font-size:0.7em;text-transform:uppercase;display:inline-block;opacity:0.65;width:47%;text-align:center;text-decoration:none;font-weight:600;letter-spacing:1px;cursor:pointer}@media screen and (max-width: 1350px){.card.svelte-1j40jyu.svelte-1j40jyu{max-width:280px}.card.svelte-1j40jyu h2.svelte-1j40jyu{font-size:1.1em}a.svelte-1j40jyu.svelte-1j40jyu{font-size:0.55rem}.card.svelte-1j40jyu p.svelte-1j40jyu{font-size:0.8em}}",
  map: null
};
const TeamCards = (0, import_index_4f192781.c)(($$result, $$props, $$bindings, slots) => {
  ...
  <div class="${"cards-container svelte-1j40jyu"}">${(0, import_index_4f192781.d)(staff, ({ name, position, descr, email, twitter, linkedin, img, bg }, i) => {
    return `<figure class="${"card svelte-1j40jyu"}">
          <div style="${"height:200px;"}" class="${"svelte-1j40jyu"}"><svg viewBox="${"-0.35 0 500.35 78.328"}" xmlns="${"http://www.w3.org/2000/svg"}" class="${"svelte-1j40jyu"}"><polygon style="${"fill: " + (0, import_index_4f192781.e)(bg) + ";"}" points="${"70.086 0.382 53.904 51.969 -0.944 61.327 -1.27 75.069 63.124 65.518 83.649 -0.101"}" class="${"svelte-1j40jyu"}"></polygon><polygon style="${"fill: " + (0, import_index_4f192781.e)(bg) + ";"}" points="${"120.568 -0.003 99.057 64.191 500.785 2.143 499.522 0.721 117.904 49.127 134.741 0.134"}" class="${"svelte-1j40jyu"}"></polygon></svg></div>
          <figcaption class="${["slanted-bg svelte-1j40jyu", selected === i ? "bgselected" : ""].join(" ").trim()}"><img${(0, import_index_4f192781.f)("src", img, 0)} alt="${"profile-sample4"}" style="${"border: 3px solid " + (0, import_index_4f192781.e)(bg)}" class="${["profile svelte-1j40jyu", selected === i ? "selected" : ""].join(" ").trim()}">
            <h2 class="${"svelte-1j40jyu"}">${(0, import_index_4f192781.e)(name)}<span class="${"svelte-1j40jyu"}">${(0, import_index_4f192781.e)(position)}</span></h2>
            <p class="${["svelte-1j40jyu", selected != i ? "hidden" : ""].join(" ").trim()}">${(0, import_index_4f192781.e)(descr)}</p>
            <div style="${"max-width:100%; display:flex; justify-content:space-around; max-height:60px; "}" class="${"svelte-1j40jyu"}"><div class="${"socials svelte-1j40jyu"}" style="${"width:45%"}"><div class="${"socials-item svelte-1j40jyu"}"><a${(0, import_index_4f192781.f)("href", twitter, 0)} class="${"twitter svelte-1j40jyu"}"><img alt="${"Twitter"}" src="${"images/twitter-aqua.png"}" class="${"svelte-1j40jyu"}"></a></div>
                  <div class="${"socials-item svelte-1j40jyu"}"><a href="${"mailto:" + (0, import_index_4f192781.e)(email)}" class="${"svelte-1j40jyu"}"><img${(0, import_index_4f192781.f)("alt", email, 0)} src="${"images/email-nocircle-aqua.png"}" class="${"svelte-1j40jyu"}"><a class="${"svelte-1j40jyu"}"></a>
                  </a></div>
                  <div class="${"socials-item svelte-1j40jyu"}"><a${(0, import_index_4f192781.f)("href", linkedin, 0)} class="${"svelte-1j40jyu"}"><img alt="${"LinkedIn"}" src="${"images/linkedin-aqua.png"}" class="${"svelte-1j40jyu"}"></a>
                  </div></div>
              ${selected === i ? `<button class="${"more-info svelte-1j40jyu"}" style="${"border-color: " + (0, import_index_4f192781.e)(bg)}"${(0, import_index_4f192781.f)("data-card-id", i, 0)}>Less Info</button>` : `<button class="${"more-info svelte-1j40jyu"}" style="${"border-color: " + (0, import_index_4f192781.e)(bg)}"${(0, import_index_4f192781.f)("data-card-id", i, 0)}>More Info</button>`}
          </div></figcaption>
          <svg viewBox="${"-1.79 0 501.79 94.114"}" xmlns="${"http://www.w3.org/2000/svg"}" class="${"svelte-1j40jyu"}"><polygon style="${"fill: " + (0, import_index_4f192781.e)(bg) + ";"}" points="${"500.159 16.553 432.482 24.328 392.825 93.844 409.667 93.703 443.069 37.609 499.889 30.393"}" class="${"svelte-1j40jyu"}"></polygon><polygon style="${"fill: " + (0, import_index_4f192781.e)(bg)}" points="${"352.106 94.674 335.059 94.797 363.621 47.452 -1.746 94.183 -1.798 80.123 390.963 29.985"}" class="${"svelte-1j40jyu"}"></polygon></svg>
        </figure>`;
  })}</div>
</section>`;
});
...
const css$4 = {
  code: '.soft-mode .soft.svelte-ctuk6w.svelte-ctuk6w{display:block !important}.soft-mode .hard.svelte-ctuk6w.svelte-ctuk6w{display:none !important}.soft.svelte-ctuk6w.svelte-ctuk6w{display:none}@media screen and (max-width: 820px){.footer-content.svelte-ctuk6w.svelte-ctuk6w{grid-template:"connect"\r\n            "register" !important;padding-top:2rem !important}#links.svelte-ctuk6w.svelte-ctuk6w{display:none}.footer.svelte-ctuk6w.svelte-ctuk6w{height:auto !important}#logo.svelte-ctuk6w.svelte-ctuk6w{display:flex !important;align-items:center;justify-content:center}.col-content.svelte-ctuk6w.svelte-ctuk6w{margin-top:0 !important;margin-bottom:10px !important}.col-content.svelte-ctuk6w a.svelte-ctuk6w{width:18% !important}}h4.svelte-ctuk6w.svelte-ctuk6w{font-size:1.2rem;color:black;margin-bottom:0}.soft-mode h4.svelte-ctuk6w.svelte-ctuk6w{color:white}.col-content.svelte-ctuk6w a.svelte-ctuk6w{width:25%;margin-left:5px}a.svelte-ctuk6w>img.svelte-ctuk6w{width:100%}#logo.svelte-ctuk6w.svelte-ctuk6w{display:none}#Contact.svelte-ctuk6w.svelte-ctuk6w{grid-area:connect}#register.svelte-ctuk6w.svelte-ctuk6w{grid-area:register}#links.svelte-ctuk6w.svelte-ctuk6w{grid-area:links}img.svelte-ctuk6w.svelte-ctuk6w{width:50%;margin-bottom:20px;margin-top:10px}.col-content.svelte-ctuk6w.svelte-ctuk6w{margin-top:3rem}a.svelte-ctuk6w.svelte-ctuk6w{color:black;font-weight:400}.soft-mode a.svelte-ctuk6w.svelte-ctuk6w{color:white !important}ul.svelte-ctuk6w.svelte-ctuk6w{list-style:none;margin:0px;padding:0px;text-align:left}.footer-col.svelte-ctuk6w.svelte-ctuk6w{margin-left:1rem;margin-right:1rem}.footer.svelte-ctuk6w a.svelte-ctuk6w{color:black}.footer.svelte-ctuk6w.svelte-ctuk6w{width:100%;height:400px;background-color:aqua;border-top:1px solid black}.soft-mode .footer.svelte-ctuk6w.svelte-ctuk6w{background-color:#001220;color:white}.footer-content.svelte-ctuk6w.svelte-ctuk6w{padding-top:5rem;margin-left:auto;margin-right:auto;max-width:80rem;display:grid;align-items:start;grid-template:"links register connect" auto / 0.8fr 3fr 0.8fr}',
  map: null
};
const Footer = (0, import_index_4f192781.c)(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$4);
  return `<footer class="${"footer svelte-ctuk6w"}"><div class="${"footer-content svelte-ctuk6w"}"><div class="${"footer-col svelte-ctuk6w"}" id="${"links"}"><h4 class="${"svelte-ctuk6w"}">Links</h4>
            <ul class="${"col-content svelte-ctuk6w"}"><li><a href="${"#Trailer"}" class="${"svelte-ctuk6w"}">Trailer</a></li>
                <li><a href="${"#Table"}" class="${"svelte-ctuk6w"}">About</a></li>
                <li><a href="${"#Challenge"}" class="${"svelte-ctuk6w"}">Challenge System</a></li>
                <li><a href="${"#Vote"}" class="${"svelte-ctuk6w"}">Vote Token</a></li>
                <li><a href="${"#NFT"}" class="${"svelte-ctuk6w"}">NFTs</a></li>
                <li><a href="${"#Ambassadors"}" class="${"svelte-ctuk6w"}">Ambassador Program</a></li>
                <li><a href="${"#Roadmap"}" class="${"svelte-ctuk6w"}">Roadmap</a></li>
                <li><a href="${"#Tokenomics"}" class="${"svelte-ctuk6w"}">Tokenomics</a></li></ul></div>
        <div class="${"footer-col svelte-ctuk6w"}" id="${"register"}"><h4 id="${"links"}" class="${"svelte-ctuk6w"}">Newsletter Subscription</h4>
            <div class="${"col-content svelte-ctuk6w"}">${(0, import_index_4f192781.v)(NewsletterSignup, "NewsletterSignup").$$render($$result, { color: "black" }, {}, {})}</div></div>
        <div class="${"footer-col svelte-ctuk6w"}" id="${"Contact"}"><h4 id="${"links"}" class="${"svelte-ctuk6w"}">Connect</h4>
            <div class="${"col-content svelte-ctuk6w"}" style="${"display:flex; justify-content:space-between"}"><a href="${"mailto:info@allskills.ca"}" class="${"svelte-ctuk6w"}"><img alt="${"Email"}" src="${"images/email.png"}" id="${"email"}" class="${"svelte-ctuk6w"}"></a>
                <a href="${"https://www.twitter.com/@AllSkillsNFT"}" class="${"svelte-ctuk6w"}"><img alt="${"Discord"}" src="${"images/discord.png"}" id="${"discord"}" class="${"svelte-ctuk6w"}"></a>
                <a href="${"https://www.instagram.com/AllSkillsNFT"}" class="${"svelte-ctuk6w"}"><img alt="${"Instagram"}" src="${"images/instagram.png"}" id="${"instagram"}" class="${"svelte-ctuk6w"}"></a>
                <a href="${"https://www.twitter.com/@AllSkillsNFT"}" class="${"svelte-ctuk6w"}"><img alt="${"Twitter"}" src="${"images/twitter.png"}" id="${"twitter"}" class="${"svelte-ctuk6w"}"></a></div></div></div>
    <div id="${"logo"}" class="${"svelte-ctuk6w"}"><img class="${"soft svelte-ctuk6w"}" alt="${"Logo"}" style="${"margin-right: 12px;"}" src="${"images/logo-white-bottom.png"}">
        <img class="${"hard svelte-ctuk6w"}" alt="${"Logo"}" style="${"margin-right: 12px;"}" src="${"images/logo-dark-bottom.png"}"></div>
</footer>`;
});
...
const css$2 = {
  code: `#trailer:hover .play{cursor:pointer;background:red;opacity:0.9}.play{font-size:1.1em;transform:translateY(130px);position:absolute;left:0;right:0;margin:auto;background:#3b3636;opacity:0.75;border-radius:50% / 10%;color:#FFFFFF;height:3em;padding:0;text-align:center;text-indent:0.1em;transition:all 150ms ease-out;width:4em;top:25%;cursor:pointer}.play::before{background:inherit;border-radius:5% / 50%;bottom:9%;content:"";left:-5%;position:absolute;right:-5%;top:9%}.play::after{border-style:solid;border-width:1em 0 1em 1.732em;border-color:transparent transparent transparent rgba(255, 255, 255, 0.75);content:' ';font-size:0.75em;height:0;margin:-1em 0 0 -0.75em;top:50%;position:absolute;width:0}#trailer-container.svelte-q17sv1{margin-top:100px;height:600px;display:flex;justify-content:center;position:relative;background-position:center;background-repeat:no-repeat;background-size:35% 90%}#trailer.svelte-q17sv1{display:flex;margin:60px auto;overflow:hidden;justify-content:center;width:300px}.trailer{overflow:hidden;object-fit:cover}@media screen and (max-width: 820px){#trailer-container{width:auto !important;padding:10px;background-size:100% 90% !important}}`,
  map: null
};
const Trailer = (0, import_index_4f192781.c)(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$2);
  return `<div id="${"trailer-container"}" style="${"background-image:var(--trailerBg);"}" data-embed="${"O2A5MIWsCFI"}" class="${"svelte-q17sv1"}"><div id="${"trailer"}" class="${"svelte-q17sv1"}"></div>
</div>`;
});
