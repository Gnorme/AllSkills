...
const NFT = (0, import_index_4f192781.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `<section id="${"NFT"}"><h2 class="${"section-title"}" style="${"text-decoration-color: var(--thirdColor); -webkit-text-decoration-color: var(--thirdColor)"}">ALLSKILLS NFTs</h2>
    <div class="${"NFT-container svelte-afve9w"}"><div class="${"nft-section svelte-afve9w"}" style="${"margin-bottom:50px;"}"><div class="${"image first marker-highlight svelte-afve9w"}"><h3 style="${"position: absolute; top: 40%; z-index:2; font-size: 2rem; font-family: var(--headerFont); color: white;"}">Coming soon</h3>
...
const css$2 = {
  code: `.youtube:hover .play{cursor:pointer;background:red;opacity:0.9}.play{font-size:1.1em;transform:translateY(130px);position:absolute;left:0;right:0;margin:auto;background:#3b3636;opacity:0.75;border-radius:50% / 10%;color:#FFFFFF;height:3em;padding:0;text-align:center;text-indent:0.1em;transition:all 150ms ease-out;width:4em;top:25%}.play::before{background:inherit;border-radius:5% / 50%;bottom:9%;content:"";left:-5%;position:absolute;right:-5%;top:9%}.play::after{border-style:solid;border-width:1em 0 1em 1.732em;border-color:transparent transparent transparent rgba(255, 255, 255, 0.75);content:' ';font-size:0.75em;height:0;margin:-1em 0 0 -0.75em;top:50%;position:absolute;width:0}#trailer-container.svelte-ot7nyw{margin-top:100px;height:600px;display:flex;justify-content:center;position:relative;background-position:center;background-repeat:no-repeat;background-size:35% 90%}#trailer.svelte-ot7nyw{display:flex;margin:60px auto;overflow:hidden;justify-content:center;width:300px}.trailer{overflow:hidden;object-fit:cover}@media screen and (max-width: 820px){#trailer-container{width:auto !important;padding:10px;background-size:100% 90% !important}}`,
  map: null
};
const Trailer = (0, import_index_4f192781.c)(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$2);
  return `<div id="${"trailer-container"}" style="${"background-image:var(--trailerBg);"}" data-embed="${"O2A5MIWsCFI"}" class="${"svelte-ot7nyw"}"><div id="${"trailer"}" class="${"svelte-ot7nyw"}"></div>
</div>`;
});
