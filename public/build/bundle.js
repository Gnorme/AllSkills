...
var app = (function () {
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$b, 1, 4, 26);
    			...
    			add_location(rect, file$b, 5, 12, 258);
    			...
    			add_location(path0, file$b, 6, 12, 332);
    			...
    			add_location(path1, file$b, 7, 12, 461);
    			...
    			add_location(path2, file$b, 8, 12, 590);
    			...
    			add_location(svg, file$b, 4, 8, 145);
    			attr_dev(button, "class", "hamburger svelte-1xk5cw1");
    			add_location(button, file$b, 3, 4, 86);
    ...
    const file$a = "src/NewsletterSignup.svelte";
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$a, 4, 4, 70);
    			...
    			add_location(button, file$a, 5, 4, 170);
    			attr_dev(div, "class", "signup svelte-rg97zl");
    			add_location(div, file$a, 3, 0, 44);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$8 = "src/TeamCards.svelte";
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$8, 24, 12, 1306);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", "info svelte-1pw0c4j");
    			attr_dev(a, "data-card-id", /*i*/ ctx[16]);
    			add_location(a, file$8, 22, 12, 1199);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img0, file$8, 3, 8, 129);
    			...
    			add_location(img2, file$8, 11, 20, 796);
    			attr_dev(div0, "class", "socials-item svelte-1pw0c4j");
    			add_location(div0, file$8, 10, 16, 748);
    			...
    			add_location(img3, file$8, 14, 20, 921);
    			attr_dev(div1, "class", "socials-item svelte-1pw0c4j");
    			add_location(div1, file$8, 13, 16, 873);
    ...
    const file$7 = "src/Roadmap.svelte";
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h30, "class", "svelte-tpwyau");
    			add_location(h30, file$7, 3, 16, 120);
    			attr_dev(div0, "class", "header svelte-tpwyau");
    			add_location(div0, file$7, 2, 12, 83);
    			attr_dev(li0, "class", "cleared svelte-tpwyau");
    			add_location(li0, file$7, 6, 16, 191);
    			attr_dev(li1, "class", "cleared svelte-tpwyau");
    			add_location(li1, file$7, 7, 16, 276);
    			attr_dev(li2, "class", "cleared svelte-tpwyau");
    			add_location(li2, file$7, 8, 16, 356);
    			attr_dev(li3, "class", "cleared svelte-tpwyau");
    			add_location(li3, file$7, 9, 16, 415);
    			attr_dev(ul0, "class", "svelte-tpwyau");
    			add_location(ul0, file$7, 5, 12, 170);
    			attr_dev(div1, "class", "roadmap-card svelte-tpwyau");
    			add_location(div1, file$7, 1, 8, 44);
    			attr_dev(h31, "class", "svelte-tpwyau");
    			add_location(h31, file$7, 14, 16, 602);
    			attr_dev(div2, "class", "header svelte-tpwyau");
    			add_location(div2, file$7, 13, 12, 565);
    			attr_dev(li4, "class", "cleared svelte-tpwyau");
    			add_location(li4, file$7, 17, 16, 679);
    			attr_dev(li5, "class", "cleared svelte-tpwyau");
    			add_location(li5, file$7, 18, 16, 737);
    			attr_dev(ul1, "class", "svelte-tpwyau");
    			add_location(ul1, file$7, 16, 12, 658);
    			attr_dev(div3, "class", "roadmap-card svelte-tpwyau");
    			add_location(div3, file$7, 12, 8, 526);
    			attr_dev(h32, "class", "svelte-tpwyau");
    			add_location(h32, file$7, 23, 16, 930);
    			attr_dev(div4, "class", "header svelte-tpwyau");
    			add_location(div4, file$7, 22, 12, 893);
    			attr_dev(li6, "class", "cleared svelte-tpwyau");
    			add_location(li6, file$7, 26, 16, 999);
    			attr_dev(li7, "class", "cleared svelte-tpwyau");
    			add_location(li7, file$7, 27, 16, 1064);
    			attr_dev(ul2, "class", "svelte-tpwyau");
    			add_location(ul2, file$7, 25, 12, 978);
    			attr_dev(div5, "class", "roadmap-card svelte-tpwyau");
    			add_location(div5, file$7, 21, 8, 854);
    			attr_dev(h33, "class", "svelte-tpwyau");
    			add_location(h33, file$7, 32, 16, 1224);
    			attr_dev(div6, "class", "header svelte-tpwyau");
    			add_location(div6, file$7, 31, 12, 1187);
    			attr_dev(li8, "class", "cleared svelte-tpwyau");
    			add_location(li8, file$7, 35, 16, 1293);
    			attr_dev(li9, "class", "cleared svelte-tpwyau");
    			add_location(li9, file$7, 36, 16, 1361);
    			attr_dev(li10, "class", "svelte-tpwyau");
    			add_location(li10, file$7, 37, 16, 1450);
    			attr_dev(li11, "class", "svelte-tpwyau");
    			add_location(li11, file$7, 38, 16, 1490);
    			attr_dev(ul3, "class", "svelte-tpwyau");
    			add_location(ul3, file$7, 34, 12, 1272);
    			attr_dev(div7, "class", "roadmap-card svelte-tpwyau");
    			add_location(div7, file$7, 30, 8, 1148);
    			attr_dev(h34, "class", "svelte-tpwyau");
    			add_location(h34, file$7, 43, 16, 1652);
    			attr_dev(div8, "class", "header svelte-tpwyau");
    			add_location(div8, file$7, 42, 12, 1615);
    			attr_dev(li12, "class", "svelte-tpwyau");
    			add_location(li12, file$7, 46, 16, 1721);
    			attr_dev(li13, "class", "svelte-tpwyau");
    			add_location(li13, file$7, 47, 16, 1764);
    			attr_dev(li14, "class", "svelte-tpwyau");
    			add_location(li14, file$7, 48, 16, 1811);
    			attr_dev(li15, "class", "svelte-tpwyau");
    			add_location(li15, file$7, 49, 16, 1859);
    			attr_dev(li16, "class", "svelte-tpwyau");
    			add_location(li16, file$7, 50, 16, 1906);
    			attr_dev(li17, "class", "svelte-tpwyau");
    			add_location(li17, file$7, 51, 16, 1967);
    			attr_dev(li18, "class", "svelte-tpwyau");
    			add_location(li18, file$7, 52, 16, 2000);
    			attr_dev(ul4, "class", "svelte-tpwyau");
    			add_location(ul4, file$7, 45, 12, 1700);
    			attr_dev(div9, "class", "roadmap-card svelte-tpwyau");
    			add_location(div9, file$7, 41, 8, 1576);
    			attr_dev(h35, "class", "svelte-tpwyau");
    			add_location(h35, file$7, 57, 16, 2142);
    			attr_dev(div10, "class", "header svelte-tpwyau");
    			add_location(div10, file$7, 56, 12, 2105);
    			attr_dev(li19, "class", "svelte-tpwyau");
    			add_location(li19, file$7, 60, 16, 2211);
    			attr_dev(li20, "class", "svelte-tpwyau");
    			add_location(li20, file$7, 61, 16, 2263);
    			attr_dev(li21, "class", "svelte-tpwyau");
    			add_location(li21, file$7, 62, 16, 2307);
    			attr_dev(ul5, "class", "svelte-tpwyau");
    			add_location(ul5, file$7, 59, 12, 2190);
    			attr_dev(div11, "class", "roadmap-card svelte-tpwyau");
    			add_location(div11, file$7, 55, 8, 2066);
    			attr_dev(h36, "class", "svelte-tpwyau");
    			add_location(h36, file$7, 67, 16, 2484);
    			attr_dev(div12, "class", "header svelte-tpwyau");
    			add_location(div12, file$7, 66, 12, 2447);
    			attr_dev(li22, "class", "svelte-tpwyau");
    			add_location(li22, file$7, 70, 16, 2553);
    			attr_dev(li23, "class", "svelte-tpwyau");
    			add_location(li23, file$7, 71, 16, 2605);
    			attr_dev(li24, "class", "svelte-tpwyau");
    			add_location(li24, file$7, 72, 16, 2659);
    			attr_dev(ul6, "class", "svelte-tpwyau");
    			add_location(ul6, file$7, 69, 12, 2532);
    			attr_dev(div13, "class", "roadmap-card svelte-tpwyau");
    			add_location(div13, file$7, 65, 8, 2408);
    			attr_dev(h37, "class", "svelte-tpwyau");
    			add_location(h37, file$7, 77, 16, 2817);
    			attr_dev(div14, "class", "header svelte-tpwyau");
    			add_location(div14, file$7, 76, 12, 2780);
    			attr_dev(li25, "class", "svelte-tpwyau");
    			add_location(li25, file$7, 80, 16, 2886);
    			attr_dev(ul7, "class", "svelte-tpwyau");
    			add_location(ul7, file$7, 79, 12, 2865);
    			attr_dev(div15, "class", "roadmap-card svelte-tpwyau");
    			add_location(div15, file$7, 75, 8, 2741);
    			attr_dev(div16, "class", "roadmap-container svelte-tpwyau");
    			add_location(div16, file$7, 0, 4, 4);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			add_location(div, file$6, 91, 0, 2116);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$5 = "src/Tokenomics.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$5, 1, 4, 39);
    			...
    			add_location(p, file$5, 3, 8, 114);
    			attr_dev(path0, "data-value", "Team 10,000,000");
    			attr_dev(path0, "class", "section svelte-1cia11p");
    			attr_dev(path0, "id", "0");
    			...
    			add_location(path0, file$5, 5, 12, 390);
    			attr_dev(path1, "data-value", "Advisors 5,000,000");
    			attr_dev(path1, "class", "section svelte-1cia11p");
    			attr_dev(path1, "id", "1");
    			...
    			add_location(path1, file$5, 6, 12, 688);
    			attr_dev(path2, "data-value", "Seed Sale 10,000,000");
    			attr_dev(path2, "class", "section svelte-1cia11p");
    			attr_dev(path2, "id", "2");
    			...
    			add_location(path2, file$5, 7, 12, 1047);
    			attr_dev(path3, "data-value", "Private Sale 5,000,000");
    			attr_dev(path3, "class", "section svelte-1cia11p");
    			attr_dev(path3, "id", "3");
    			...
    			add_location(path3, file$5, 8, 12, 1409);
    			attr_dev(path4, "data-value", "Public Sale 20,000,000");
    			attr_dev(path4, "class", "section svelte-1cia11p");
    			attr_dev(path4, "id", "4");
    			...
    			add_location(path4, file$5, 9, 12, 1777);
    			attr_dev(path5, "data-value", "Liquidity Pool 20,000,000");
    			attr_dev(path5, "class", "section svelte-1cia11p");
    			attr_dev(path5, "id", "5");
    			...
    			add_location(path5, file$5, 10, 12, 2146);
    			attr_dev(path6, "data-value", "Foundation 30,000,000");
    			attr_dev(path6, "class", "section svelte-1cia11p");
    			attr_dev(path6, "id", "6");
    			...
    			add_location(path6, file$5, 11, 12, 2517);
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "id", "sv");
    			attr_dev(svg, "width", "500");
    			attr_dev(svg, "height", "500");
    			attr_dev(svg, "viewBox", "-50 -50 400 400");
    			add_location(svg, file$5, 4, 8, 278);
    			set_style(div1, "text-align", "center");
    			add_location(div1, file$5, 2, 4, 73);
    			attr_dev(span0, "class", "svelte-1cia11p");
    			add_location(span0, file$5, 16, 62, 3073);
    			attr_dev(li0, "class", "team svelte-1cia11p");
    			toggle_class(li0, "highlight", /*selected*/ ctx[0] === 0);
    			add_location(li0, file$5, 16, 12, 3023);
    			attr_dev(span1, "class", "svelte-1cia11p");
    			add_location(span1, file$5, 17, 66, 3166);
    			attr_dev(li1, "class", "advisors svelte-1cia11p");
    			toggle_class(li1, "highlight", /*selected*/ ctx[0] === 1);
    			add_location(li1, file$5, 17, 12, 3112);
    			attr_dev(span2, "class", "svelte-1cia11p");
    			add_location(span2, file$5, 18, 62, 3258);
    			attr_dev(li2, "class", "seed svelte-1cia11p");
    			toggle_class(li2, "highlight", /*selected*/ ctx[0] === 2);
    			add_location(li2, file$5, 18, 12, 3208);
    			attr_dev(span3, "class", "svelte-1cia11p");
    			add_location(span3, file$5, 19, 65, 3355);
    			attr_dev(li3, "class", "private svelte-1cia11p");
    			toggle_class(li3, "highlight", /*selected*/ ctx[0] === 3);
    			add_location(li3, file$5, 19, 12, 3302);
    			attr_dev(span4, "class", "svelte-1cia11p");
    			add_location(span4, file$5, 20, 64, 3453);
    			attr_dev(li4, "class", "public svelte-1cia11p");
    			toggle_class(li4, "highlight", /*selected*/ ctx[0] === 4);
    			add_location(li4, file$5, 20, 12, 3401);
    			attr_dev(span5, "class", "svelte-1cia11p");
    			add_location(span5, file$5, 21, 67, 3554);
    			attr_dev(li5, "class", "liquidity svelte-1cia11p");
    			toggle_class(li5, "highlight", /*selected*/ ctx[0] === 5);
    			add_location(li5, file$5, 21, 12, 3499);
    			attr_dev(span6, "class", "svelte-1cia11p");
    			add_location(span6, file$5, 22, 68, 3659);
    			attr_dev(li6, "class", "foundation svelte-1cia11p");
    			toggle_class(li6, "highlight", /*selected*/ ctx[0] === 6);
    			add_location(li6, file$5, 22, 12, 3603);
    			set_style(ul, "display", "table-cell");
    			set_style(ul, "vertical-align", "middle");
    			attr_dev(ul, "class", "svelte-1cia11p");
    			add_location(ul, file$5, 15, 8, 2953);
    			set_style(div2, "width", "25%");
    			set_style(div2, "display", "table");
    			add_location(div2, file$5, 14, 4, 2906);
    			attr_dev(div3, "class", "tokenomics-container svelte-1cia11p");
    			...
    			attr_dev(div4, "class", "svelte-1cia11p");
    			add_location(div4, file$5, 26, 0, 3724);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$4 = "src/Challenge.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "challenge-container");
    ...
    const file$3 = "src/VoteToken.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div22 = element("div");
    			h24 = element("h2");
    			h24.textContent = "Governance Tokenomics";
    			t41 = space();
    			...
    			add_location(img0, file$2, 10, 22, 324);
    			attr_dev(div0, "class", "card svelte-1trdi39");
    			add_location(div0, file$2, 10, 4, 306);
    			if (!src_url_equal(img1.src, img1_src_value = "images/Dunk.jpg")) attr_dev(img1, "src", img1_src_value);
    			add_location(img1, file$2, 11, 22, 383);
    			attr_dev(div1, "class", "card svelte-1trdi39");
    			add_location(div1, file$2, 11, 4, 365);
    			if (!src_url_equal(img2.src, img2_src_value = "images/skateboard.jpg")) attr_dev(img2, "src", img2_src_value);
    			add_location(img2, file$2, 12, 22, 442);
    			attr_dev(div2, "class", "card svelte-1trdi39");
    			add_location(div2, file$2, 12, 4, 424);
    			if (!src_url_equal(img3.src, img3_src_value = "images/runner.jpg")) attr_dev(img3, "src", img3_src_value);
    			add_location(img3, file$2, 13, 22, 507);
    			attr_dev(div3, "class", "card svelte-1trdi39");
    			add_location(div3, file$2, 13, 4, 489);
    			attr_dev(div4, "id", "Trailer");
    			attr_dev(div4, "class", "content svelte-1trdi39");
    			add_location(div4, file$2, 9, 0, 266);
    			attr_dev(h20, "class", "svelte-1trdi39");
    			add_location(h20, file$2, 17, 4, 588);
    			...
    			add_location(img4, file$2, 20, 36, 716);
    			attr_dev(div5, "class", "table-icon svelte-1trdi39");
    			add_location(div5, file$2, 20, 12, 692);
    			attr_dev(h30, "class", "svelte-1trdi39");
    			add_location(h30, file$2, 22, 16, 849);
    			attr_dev(p0, "class", "svelte-1trdi39");
    			add_location(p0, file$2, 23, 16, 894);
    			attr_dev(div6, "class", "grid-item-text");
    			add_location(div6, file$2, 21, 12, 803);
    			attr_dev(div7, "class", "grid-item svelte-1trdi39");
    			add_location(div7, file$2, 19, 8, 655);
    			...
    			add_location(img5, file$2, 27, 36, 1265);
    			attr_dev(div8, "class", "table-icon svelte-1trdi39");
    			add_location(div8, file$2, 27, 12, 1241);
    			attr_dev(h31, "class", "svelte-1trdi39");
    			add_location(h31, file$2, 29, 16, 1392);
    			attr_dev(p1, "class", "svelte-1trdi39");
    			add_location(p1, file$2, 30, 16, 1436);
    			attr_dev(div9, "class", "grid-item-text");
    			add_location(div9, file$2, 28, 12, 1346);
    			attr_dev(div10, "class", "grid-item svelte-1trdi39");
    			add_location(div10, file$2, 26, 8, 1204);
    			...
    			add_location(img6, file$2, 34, 36, 1751);
    			attr_dev(div11, "class", "table-icon svelte-1trdi39");
    			add_location(div11, file$2, 34, 12, 1727);
    			attr_dev(h32, "class", "svelte-1trdi39");
    			add_location(h32, file$2, 36, 16, 1884);
    			attr_dev(p2, "class", "svelte-1trdi39");
    			add_location(p2, file$2, 37, 16, 1927);
    			attr_dev(div12, "class", "grid-item-text");
    			add_location(div12, file$2, 35, 12, 1838);
    			attr_dev(div13, "class", "grid-item svelte-1trdi39");
    			add_location(div13, file$2, 33, 8, 1690);
    			...
    			add_location(img7, file$2, 41, 36, 2188);
    			attr_dev(div14, "class", "table-icon svelte-1trdi39");
    			add_location(div14, file$2, 41, 12, 2164);
    			attr_dev(h33, "class", "svelte-1trdi39");
    			add_location(h33, file$2, 43, 16, 2321);
    			attr_dev(p3, "class", "svelte-1trdi39");
    			add_location(p3, file$2, 44, 16, 2363);
    			attr_dev(div15, "class", "grid-item-text");
    			add_location(div15, file$2, 42, 12, 2275);
    			attr_dev(div16, "class", "grid-item svelte-1trdi39");
    			add_location(div16, file$2, 40, 8, 2127);
    			attr_dev(div17, "class", "table-content svelte-1trdi39");
    			add_location(div17, file$2, 18, 4, 618);
    			set_style(span0, "color", "aqua");
    			add_location(span0, file$2, 49, 12, 2634);
    			set_style(span1, "background-color", "aqua");
    			set_style(span1, "color", "rgb(54,54,54)");
    			add_location(span1, file$2, 49, 91, 2713);
    			set_style(span2, "background-color", "aqua");
    			set_style(span2, "color", "rgb(54,54,54)");
    			add_location(span2, file$2, 49, 321, 2943);
    			attr_dev(h34, "class", "svelte-1trdi39");
    			add_location(h34, file$2, 49, 8, 2630);
    			attr_dev(div18, "class", "powered-by svelte-1trdi39");
    			add_location(div18, file$2, 48, 4, 2596);
    			attr_dev(h21, "class", "svelte-1trdi39");
    			add_location(h21, file$2, 52, 8, 3109);
    			attr_dev(div19, "id", "Challenge");
    			set_style(div19, "width", "100%");
    			add_location(div19, file$2, 51, 4, 3059);
    			attr_dev(h22, "class", "svelte-1trdi39");
    			add_location(h22, file$2, 56, 8, 3225);
    			attr_dev(div20, "id", "Stablecoin");
    			set_style(div20, "width", "100%");
    			add_location(div20, file$2, 55, 4, 3174);
    			attr_dev(h23, "class", "svelte-1trdi39");
    			add_location(h23, file$2, 59, 8, 3321);
    			attr_dev(div21, "id", "Roadmap");
    			set_style(div21, "width", "100%");
    			add_location(div21, file$2, 58, 4, 3273);
    			attr_dev(h24, "class", "svelte-1trdi39");
    			add_location(h24, file$2, 63, 8, 3439);
    			attr_dev(div22, "id", "Tokenomics");
    			set_style(div22, "width", "100%");
    			add_location(div22, file$2, 62, 4, 3388);
    			attr_dev(h25, "class", "svelte-1trdi39");
    			add_location(h25, file$2, 67, 8, 3555);
    			attr_dev(div23, "id", "Team");
    			set_style(div23, "width", "100%");
    			add_location(div23, file$2, 66, 4, 3510);
    			attr_dev(h26, "class", "svelte-1trdi39");
    			add_location(h26, file$2, 71, 8, 3661);
    			attr_dev(div24, "id", "Partners");
    			set_style(div24, "width", "100%");
    			add_location(div24, file$2, 70, 4, 3612);
    			attr_dev(h27, "class", "svelte-1trdi39");
    			add_location(h27, file$2, 74, 8, 3741);
    			attr_dev(div25, "id", "News");
    			set_style(div25, "width", "100%");
    			add_location(div25, file$2, 73, 4, 3696);
    			attr_dev(div26, "class", "text-content svelte-1trdi39");
    			add_location(div26, file$2, 16, 0, 556);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(roadmap, div21, null);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-ltslnt");
