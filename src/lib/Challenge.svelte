<section id="Challenge">
    <h2 class="section-title" style="text-decoration-color: var(--firstColor); -webkit-text-decoration-color: var(--firstColor)">Challenge System</h2>
    <div class="challenge-container">
        ...
        <div class="info-section">
            ...
            <div class="content second">
                ...
                <h3 class="title" style="background-image: linear-gradient(var(--firstColor), var(--firstColor));">{$t('en.home.challenges.videos.title')}</h3>
                <p>{$t('en.home.challenges.videos.pStart')} <span style="color:var(--firstColor);">{$t('en.home.challenges.videos.highlighted')}</span>{$t('en.home.challenges.videos.pEnd')}</p>
                </div>
            </div>
        </div>
        <div class="info-section">
            <div class="image second">
                <img alt="Upload videos" class="phone" src="images/challenge_upload.png" />
            ...
            <div class="content first">
                ...
                <h3 class="title" style="background-image: linear-gradient(var(--secondColor),var(--secondColor));">{$t('en.home.challenges.challenges.title')}</h3>
                <p>{$t('en.home.challenges.challenges.pStart')}  <span style="color:var(--secondColor);">{$t('en.home.challenges.challenges.highlighted')}</span> {$t('en.home.challenges.challenges.pEnd')}</p>
                </div>
            </div>
        </div>
        <div class="info-section">
            <div class="image first">
                <img alt="Users vote for winner" class="phone" src="images/challenge_current.png" />
            ...
            <div class="content second">
                ...
                <h3 class="title" style="background-image: linear-gradient(blueviolet,blueviolet);">{$t('en.home.challenges.votes.title')}</h3>
                <p>{$t('en.home.challenges.votes.pStart')} <span style="color:blueviolet;">{$t('en.home.challenges.votes.highlighted')}</span> {$t('en.home.challenges.votes.pEnd')}</p>
                </div>
            </div>
        </div>
        <div class="info-section">
            ...
            <div class="content first">
                ...
                <h3 class="title" style="background-image: linear-gradient(gold,gold);">{$t('en.home.challenges.earn.title')}</h3>
                <p>{$t('en.home.challenges.earn.pStart')}<span style="color: gold;">{$t('en.home.challenges.earn.highlighted')}</span></p>
                </div>
            </div>
        </div>
    </div>
