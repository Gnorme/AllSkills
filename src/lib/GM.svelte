<section id="GM">
    <h2 class="section-title" style="text-decoration-color: var(--firstColor); -webkit-text-decoration-color: var(--firstColor)">GM Mode</h2>
        ...
        <div class="GM-section">
            ...
            <div class="content first">
                <div>
                        <div class="info left">
                            <ul id="gm-info">
                                <li><h4>{$t('en.home.gm.1.pStart')} <span style="color:aqua">{$t('en.home.gm.1.highlight')}</span></h4></li>
                                <li><h4>{$t('en.home.gm.2.pStart')} {$t('en.home.gm.2.highlight')} {$t('en.home.gm.2.pEnd')}</h4></li>
                                <li><h4>{$t('en.home.gm.3.pStart')} <span style="color:aqua">{$t('en.home.gm.3.highlight')}</span> {$t('en.home.gm.3.pEnd')}</h4></li>
                                <li><h4>{$t('en.home.gm.4.pStart')} <span style="color:aqua">{$t('en.home.gm.4.highlight')}</span> {$t('en.home.gm.4.pEnd')}</h4></li>
                            </ul>
                            <svg class="waves" style="display:none; margin-top:80px;" viewBox="0 0 900 173" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M0 45.604L21.5 45.0841C43 44.4992 86 43.4594 128.8 39.235C171.7 35.0107 214.3 27.6019 257.2 20.778C300 13.9541 343 7.71508 385.8 3.68573C428.7 -0.343628 471.3 -2.03335 514.2 5.1155C557 12.2644 600 28.2518 642.8 28.8367C685.7 29.3566 728.3 14.409 771.2 8.36498C814 2.25596 857 5.11549 878.5 6.48027L900 7.91005V149.587H878.5C857 149.587 814 149.587 771.2 149.587C728.3 149.587 685.7 149.587 642.8 149.587C600 149.587 557 149.587 514.2 149.587C471.3 149.587 428.7 149.587 385.8 149.587C343 149.587 300 149.587 257.2 149.587C214.3 149.587 171.7 149.587 128.8 149.587C86 149.587 43 149.587 21.5 149.587H0V45.604Z" fill="#77AED7"/>
...
<script>
    ...
    let descriptions = {
        ...
        arweave: {title:"arweave", description: "Arweave is a new type of storage that backs data with sustainable and perpetual endowments, allowing users and developers to truly store data forever – for the very first time. As a collectively owned hard drive that never forgets, Arweave allows us to remember and preserve valuable information, apps, and history indefinitely. By preserving history, it prevents others from rewriting it."},
