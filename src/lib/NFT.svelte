<section id="NFT">
    <h2 class="section-title" style="text-decoration-color: var(--thirdColor); -webkit-text-decoration-color: var(--thirdColor)">ALLSKILLS NFTs</h2>
    <div class="NFT-container">
        <div class="nft-section" style="margin-bottom:50px;">
            <div class="image first marker-highlight">
                <h1 style="position: absolute; top: 40%; z-index:2; font-size: 2rem; font-family: var(--headerFont); color: white;">Coming soon</h1>
            ...
            <div class="content second">
                    <div class="info right">
                        ...
                        <svg class="lines" viewBox="3 30 500.35 50.328" xmlns="http://www.w3.org/2000/svg">
