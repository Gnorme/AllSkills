...
<script>
    ...
    let tableIcons = ["handshake.png", "earn.png", "stamps.png", "ambassador.png"]
    let softTableIcons = ["handshake_soft.png", "earn_soft.png", "stamps_soft.png", "ambassador_soft.png"]
