<section id="Tokenomics">
    <h2 class="section-title center" style="text-decoration-color: var(--firstColor); -webkit-text-decoration-color: var(--firstColor)">Tokenomics</h2>
    <div class="tokenomics-container">
        <div class="list" style="width:30%; display: flex;">
            <div id="left-container">
                <h2>10,000,000,000 $Skills Tokens</h2>
                <p>With a max supply of 10,000,000,000 our <span class="highlight">$Skills token</span> will be used for voting on how you think AllSkills should operate, getting access to our beta and early access to new features, entering raffles to earn exclusive prizes, staking to earn $Vote tokens, and paying gas fees.</p>
            </div>
        </div>
        <div class="svg-container">
            <img alt="$Skills Token" id="coin" src="images/coin.png" />
            ...
            <!--<svg xmlns="http://www.w3.org/2000/svg" id="sv" viewBox="-50 -50 400 400">
                ...
                <path on:mouseover={bringToFront} on:mousemove={showTooltip} data-value="Private Sale 5,000,000" on:mouseleave={deselect} class="section" id="3" fill="#bc5090" d="M299.9999998572106, 149.99345501530712 A150,150 0 0 1 292.6609042625172,196.34507951229457 L254.61799645917927,183.98639164234936 A110,110 0 0 0 259.9999998952878,149.99520034455855 Z"></path>
...
2
    ...
    let data = {
        labels: ['Team','Advisors', 'Foundation', 'Seed Sale', 'Private Sale', 'Public Sale', 'Liquidity Pool'],
        datasets: [
            {
                name:"Test", values: [10,5,10,10,10,15,40]
            }
        ]
    }
</script>