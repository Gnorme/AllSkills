...
<section id="Tokens" style="background-image: url('images/bluewaves.svg')">
  <h2
  ...
  <div class="vote-container">
    <div class="column-header">
      <h2 style="color:blueviolet">$VOTE Token</h2>
    </div>
    <div class="section left">
      <span class="title">
        <img alt="Stable value" src="images/stable.png" />
        <h3>{$t("content.home.vote.stable.title")}</h3>
      </span>
      <p>
        {$t("content.home.vote.stable.pStart")}
        <span class="highlight"
          >{$t("content.home.vote.stable.highlighted")}</span
        >
        {$t("content.home.vote.stable.pEnd")}
      </p>
    </div>
    <div class="section left">
      <span class="title">
        ...
        <h3>{$t("content.home.vote.cast.title")}</h3>
      </span>
      <p>
        {$t("content.home.vote.cast.pStart")}
        <span class="highlight">{$t("content.home.vote.cast.highlighted")}</span
        >
        {$t("content.home.vote.cast.pEnd")}
      </p>
    </div>
    <div class="section left">
      <span class="title">
        ...
        <h3>{$t("content.home.vote.win.title")}</h3>
      </span>
      <p>
        {$t("content.home.vote.win.pStart")}
        <span class="highlight">{$t("content.home.vote.win.highlighted")}</span>
        {$t("content.home.vote.win.pEnd")}
      </p>
    </div>
    <div class="column middle">
      ...
      <div class="coin">
        <div class="front jump">
          ...
          <span
            class="currency"
            style="background-image:url('../images/logo-yellow-s.png')"
          />
          <div class="shapes">
    ...
    <div class="column-header">
      <h2 style="color:blueviolet">$SKILL Token</h2>
    </div>
    <div class="section right">
      <span class="title">
        <img class="soft" alt="Stake" src="images/stake_soft.png" />
        <img class="hard" alt="Stake" src="images/stake.png" />
        <h3>{$t("content.home.vote.earn.title")}</h3>
      </span>
      <p>
        {$t("content.home.vote.earn.pStart")}
        <span class="highlight">{$t("content.home.vote.earn.highlighted")}</span
        >
        {$t("content.home.vote.earn.pEnd")}
      </p>
    </div>
    <div class="section right">
      <span class="title">
        ...
        <h3>{$t("content.home.vote.marketplace.title")}</h3>
      </span>
      <p>
        {$t("content.home.vote.marketplace.pStart")}
        <span class="highlight"
          >{$t("content.home.vote.marketplace.highlighted")}</span
        >
        {$t("content.home.vote.marketplace.pEnd")}
      </p>
    </div>
    <div class="section right">
      <span class="title">
        ...
        <h3>{$t("content.home.vote.utility.title")}</h3>
      </span>
      <p>
        {$t("content.home.vote.utility.pStart")}
        <span class="highlight"
          >{$t("content.home.vote.utility.highlighted")}</span
        >
      </p>
    </div>
  </div>
